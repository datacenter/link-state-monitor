...
Script usage: link-monitor.py -m <interfaces> -a <interfaces> -l "$command" 
    Examples:
...
Script equires an EEM to be configured as below to work,
...
#            sys.exit(1)
    ...
    def update_interface_status(self):
        ...
        for line in cmd.processed_output:
